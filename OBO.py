...
oboFile = open('/home/nid16/workspace/Project_With_New_Data/New_GO.obo','r')
...
# ^ugly
outputfile = codecs.open('/home/nid16/workspace/Project/GO_Children&Parents.txt', encoding='utf-8', mode='w')
